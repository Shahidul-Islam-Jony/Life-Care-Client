...
import detol from '../../../assets/images/personalCare/bange.webp'

const PersonalCareCom = () => {

    return (
        <div data-aos="fade-up" data-aos-duration="2000" className=''>
            <h2 className='text-3xl font-bold font-serif text-center text-blue-600 textShadow border-b-4 border-double border-blue-500 my-10 w-fit mx-auto'>Personal Care</h2>
            ...
            <div className='flex justify-center mt-10'>
                <Link to='allMedicine/personal' className='btn btn-sm btn-outline'>See All</Link>
            </div>
        </div>
    );
};

export default PersonalCareCom;