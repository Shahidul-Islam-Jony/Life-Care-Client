...
const Navbar = () => {
    ...
    return (
            <div className="navbar md:px-6 text-blue-600 font-bold bg-white shadow-2xl border-2 border-b-blue-700 rounded-b-xl">
                {/* small devices */}
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        {
                            isOpen ? <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                ...
                <div className="navbar-end">
                    <Link to='/login' className="btn btn-sm btn-outline text-base font-bold text-blue-600 hover:bg-green-800">Login</Link>
                </div>
            </div>
    );
};
